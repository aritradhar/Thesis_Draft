...
authors mostly concentrated on specific data-structures like \code{FAT-32},
\code{ext2}, \code{CTAS} (a set of air-traffic control tools developed at the
...
system \code{RCV} which recovers applications from divide-by-zero and
null-deference error. Their tool replaces \code{SIGFPE} and \code{SIGSEGV}
...
patching until the program stabilizes which they called as \code{error
shepherding}.
