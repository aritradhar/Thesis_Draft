...
\begin{figure}[!htb]
\centering
\includegraphics[width=5.6in]{images/OverallDesign.pdf}
...
\begin{figure*}
\centering
  \includegraphics[width = 6.0in]{images/InfoflowFramework.pdf}
  \caption{InfoFlow Framework design}
  \label{fig:InfoFlowModule}
\end{figure*}
